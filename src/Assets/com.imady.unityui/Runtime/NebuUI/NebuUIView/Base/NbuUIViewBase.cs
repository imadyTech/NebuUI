...
{
    public abstract class NbuUIViewBase : NebuEventUnityObjectBase, INbuUIView
    {
        ...
        public virtual INbuUIView SetTemplate(GameObject template)
        {
            ViewTemplate = template;
            return this as INbuUIView;
        }
        public virtual INbuUIView SetTemplate()
        {
        ...
        public virtual List<INbuUIView> RenderListview(IEnumerable<object> sourceVMCollection, Type template, LayoutGroup container, Func<Type, GameObject, bool, INbuUIView> resourceLoader)
        {
            //ClearLayoutContainer(container);
            var resultViewList = new List<INbuUIView>();
        ...
        /// <returns></returns>
        protected virtual List<INbuUIView> RenderListview<T>(List<T> sourceVMs, LayoutGroup container, Func<Type, GameObject, bool, INbuUIView> resourceLoader)
        {
            //ClearLayoutContainer(container);
            var resultViewList = new List<INbuUIView>();
